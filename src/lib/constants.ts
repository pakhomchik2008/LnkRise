...
// Billing stays out of the nav — still a ComingNext stub, and a dead-end
// link mid-demo is worse than no link at all. The route still exists and
// says plainly what's missing if someone lands there directly.
