    ...
    commentAngles: [
      {
        ...
        starters: [
          "The part about {topic} matches what I have seen — the failure mode is usually",
          "Worth adding: teams that get this right tend to",
        ],
      },
      {
        ...
        starters: [
          "We hit this exact problem. What worked was",
          "One thing that is easy to miss here:",
        ],
      },
      {
        ...
        starters: [
          "The bit about {topic} is underrated. In my experience,",
          "This matches my read, with one caveat:",
        ],
      },
    ],
    weekThemes: [
    ...
    commentAngles: [
      {
        ...
        starters: [
          "Agreed on the main point. The part I would push on is",
          "This is right, and it gets more true when",
        ],
      },
      {
        ...
        starters: [
          "I read this differently. In practice,",
          "The usual answer here is {topic}, but that assumes",
        ],
      },
      {
        ...
        starters: [
          "Short version:",
          "The thing nobody tells you at this stage is",
        ],
      },
    ],
    weekThemes: [
    ...
    commentAngles: [
      {
        ...
        starters: [
          "We see this a lot. The usual root cause is",
          "Before changing anything, it is worth checking whether",
        ],
      },
      {
        ...
        starters: [
          "The practical effect for most {industry} teams is",
          "Worth flagging what this does and does not change:",
        ],
      },
      {
        ...
        starters: [
          "This matches what we see across {industry}.",
          "The second-order effect people miss here is",
        ],
      },
    ],
    weekThemes: [
    ...
    commentAngles: [
      {
        ...
        starters: [
          "This lines up with something I ran into recently:",
      ...
      },
      {
        ...
        starters: [
          "Partial answer from my side:",
          "Depends on scale, in my experience —",
        ],
      },
      {
        ...
        starters: [
          "Congratulations — the {topic} part especially.",
          "Well deserved. Curious what the first ninety days look like.",
        ],
      },
    ],
    weekThemes: [
    ...
    commentAngles: [
      {
        ...
        starters: [
          "Strong post, and I want to argue with one part of it:",
          "This is true up to a point. Past that,",
        ],
      },
      {
        ...
        starters: [
          "The headline number is less interesting than",
          "Worth reading the methodology before drawing the obvious conclusion —",
        ],
      },
      {
        ...
        starters: [
          "This gets repeated a lot. The evidence is thinner than it sounds:",
          "Small correction, offered in good faith:",
        ],
      },
    ],
    weekThemes: [
